...
import com.ryu.ultramania.model.RememberMeToken;
import com.ryu.ultramania.repository.RememberMeTokenRepository;
...
public class RememberMeTokenService implements PersistentTokenRepository {
    ...
    public void removeUserTokens(String username) {
        ...
        if(tokens != null){
            this.rememberMeTokenRepository.delete((RememberMeToken) tokens);
        }
